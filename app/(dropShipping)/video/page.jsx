...
const VideoPage = () => {
 ...
 {/* playIcon */}
 <img onClick={() => setShowVideo(!showVideo)} className='w-15 h-15 absolute top-2/3 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full cursor-pointer'src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRT7dAm2xeRPWO5PJWhJnhfUeG3Syl3ws8wnw&s"} />
 {/* video player */}
