...
const StatsGrid = ({ data }) => {
  const stats = [
    ...
    {
      icon: ShoppingBag,
      label: "অর্ডার রেফারেল বোনাস",
      value: formatBDT(data.last30DaysSummary?.totalReferralBonus?.fromOrders || 0),
      accent: "bg-[#ffc900]/15",
    },
    {
      icon: Video,
      label: "কোর্স রেফারেল বোনাস",
      value: formatBDT(data.last30DaysSummary?.totalReferralBonus?.fromCourses || 0),
      accent: "bg-[#ffc900]/15",
    },
    {
      icon: TrendingUp,
      label: "সর্বমোট রেফারেল বোনাস",
