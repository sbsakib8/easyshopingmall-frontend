    ...
    <>
      ...
      >
            ...
            <div className="flex items-center">
              <div className="flex items-center space-x-2 sm:space-x-3 group cursor-pointer">
                ...
                <button
                  ...
                  className={`p-2 sm:p-3 rounded-lg sm:rounded-xl shadow-sm border ${isMobileMenuOpen
        ...
        >
          ...
          {/* Side Menu */}
          <div
            className={`absolute top-0 left-0 h-screen w-[280px] sm:w-[320px] bg-white/80 backdrop-blur-2xl border-r border-white/50 shadow-[0_0_40px_rgba(0,0,0,0.1)] ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full"
                  ...
                  <div key={index} className="space-y-1">
                    {hasSubLinks ? (
                      <button
                        ...
                        className={`w-full flex items-center justify-between py-2.5 px-4 rounded-full font-medium ${isExpanded
