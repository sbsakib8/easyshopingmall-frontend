...
import { Upload, CheckCircle, Clock, XCircle, DollarSign, Phone, Hash } from "lucide-react";
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-gray-100">
                    <div className="mb-6">
                        <h2 className="text-2xl font-black text-gray-900 tracking-tight">Withdrawal Request</h2>
                        <p className="text-gray-500 text-sm">Request a payout from your balance</p>
                    </div>

                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label className="block text-xs font-black uppercase tracking-widest text-gray-400 mb-1.5 ml-1">Receive via</label>
                                <select 
                        ...
                        <div>
                            <label className="block text-xs font-black uppercase tracking-widest text-gray-400 mb-1.5 ml-1">Your Account Number</label>
                            <div className="relative">
                ...
                <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-gray-100 flex flex-col h-full">
                    <div className="mb-6 flex justify-between items-center">
                        <div>
                            <h2 className="text-2xl font-black text-gray-900 tracking-tight">Recent Requests</h2>
                            <p className="text-gray-500 text-sm">Status of your submitted payments</p>
                        </div>
                    ...
                    <div className="flex-grow space-y-3 overflow-y-auto max-h-[500px] pr-2 custom-scrollbar">
                        {requests.map((req) => (
                            <div key={req._id} className="p-4 rounded-2xl border border-gray-50 bg-gray-50/50 hover:bg-white hover:shadow-md transition-all group">
                                <div className="flex justify-between items-start mb-2">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{req.paymentMethod} • {req.number}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="flex justify-between items-center text-[10px] font-bold">
                                    <span className="text-gray-400">
                                        {req.transactionId ? `TxID: ${req.transactionId}` : "Processing..."}
                                    </span>
