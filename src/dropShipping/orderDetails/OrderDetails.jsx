...
const OrderDetails = () => {
 ...
 <div className="max-w-2xl mx-auto mt-6 bg-accent-content/80 shadow-sm rounded-lg overflow-hidden border border-slate-100 -up p-8 text-center space-y-6">
 ...
 <div className="max-w-2xl mx-auto bg-accent-content/80 shadow-sm rounded-lg overflow-hidden border border-slate-100 -up">
 ...
 <div className="flex items-center gap-2">
 <span className="text-slate-400">:</span>
 <span className="text-secondary font-black text-lg"> {orderData?.codTk}</span>
 </div>
 </div>
 </div>
 ...
 <span className="text-secondary font-bold text-lg">{product.price}</span>
 </td>
 </tr>
 ))}
 </tbody>
