        ...
        <div className="min-h-screen bg-slate-50/50 py-8 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="mt-2 text-slate-600">Configure your dropshipping business profile and payment details.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-6 space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center gap-4">
                                        <div className="relative w-16 h-16 rounded-2xl bg-slate-100 border border-slate-200 flex items-center justify-center overflow-hidden group">
                                            {data?.shopLogo ? (
                                                <img src={data.shopLogo} alt="Logo" className="w-full h-full object-cover" />
                                            ) : (
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {/* Website */}
                                <div className="space-y-2">
                                    <label className="text-sm font-semibold text-slate-700">Business Website</label>
                                    <div className="relative">
                    ...
                    <div className="bg-white rounded-3xl shadow-sm border border-slate-200 overflow-hidden">
                        ...
                        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                            {/* Bkash */}
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700">bKash Personal Number</label>
                                <input
                                    type="text"
                            ...
                            {/* Nagad */}
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700">Nagad Personal Number</label>
                                <input
                                    type="text"
                            ...
                            {/* Rocket */}
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700">Rocket Personal Number</label>
                                <input
                                    type="text"
                            ...
                            {/* Bank */}
                            <div className="space-y-2">
                                <label className="text-sm font-semibold text-slate-700">Bank Account Details</label>
                                <textarea
