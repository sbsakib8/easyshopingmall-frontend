      ...
      <Container>
        ...
        <div className="relative bg-gradient-to-r from-slate-900 to-slate-800 rounded-[2.5rem] p-8 lg:p-12 border border-slate-700/30 shadow-2xl overflow-hidden mb-10">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl lg:text-4xl font-black text-white tracking-tight uppercase mb-2">
              Video Resources Center
            </h2>
            <p className="text-slate-400 font-medium italic text-sm">
              Learn dropshipping strategies and scale your business with expert
              training.
            </p>
          </div>
        </div>
          ...
          <div className="animate-in fade-in duration-300">
            {!selectedCourseId ? (
              <>
                ...
                {loading ? (
                  <div className="bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 rounded-[2.5rem] p-6 lg:p-8 border border-slate-800 shadow-2xl overflow-hidden mb-10 relative animate-pulse">
                    {/* Background Effects */}
                    <div className="absolute top-0 right-0 w-96 h-96 bg-slate-800/30 rounded-full blur-[120px] -mr-20 -mt-20" />
                    <div className="absolute bottom-0 left-0 w-72 h-72 bg-slate-800/30 rounded-full blur-[100px] -ml-20 -mb-20" />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
                      ...
                      <div className="lg:col-span-7">
                        <div className="aspect-video bg-slate-800 rounded-3xl overflow-hidden border border-slate-700 shadow-2xl relative">
                          <div className="absolute inset-0 flex items-center justify-center">
                            <div className="w-16 h-16 rounded-full bg-slate-700 flex items-center justify-center">
                              <div className="w-0 h-0 border-y-8 border-y-transparent border-l-[14px] border-l-slate-500 ml-1" />
                            </div>
                          </div>
                        </div>
                      </div>
                        ...
                        <div className="lg:col-span-5 space-y-4">
                          ...
                          <p className="text-slate-400 font-medium text-xs leading-relaxed hidden md:block">
                            {demoVideo.description ||
                              "Watch this quick advertisement to see how our dropshipping platform works and how you can scale your sales instantly!"}
                          </p>
                          <div className="flex items-center gap-4 pt-2">
                            <div className="flex -space-x-2">
                              <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-emerald-500 flex items-center justify-center text-[10px] font-black text-white">
                                🏆
                              </div>
                              <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-purple-500 flex items-center justify-center text-[10px] font-black text-white">
                                ⚡
                              </div>
                              <div className="w-8 h-8 rounded-full border-2 border-slate-900 bg-pink-500 flex items-center justify-center text-[10px] font-black text-white">
                                🔥
                              </div>
                            </div>
                            <span className="text-[10px] font-black text-slate-400 uppercase tracking-wider">
                              Join 10,000+ Students online
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="flex items-center justify-between mb-6 px-2">
                    <div>
                      ...
                      <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mt-0.5">
                        Quick tactics to scale your shop today
                      </p>
                    </div>
                  </div>
                            ...
                            <div className="aspect-video bg-gray-200 relative">
                              <div className="absolute inset-0 flex items-center justify-center">
                                <div className="w-14 h-14 rounded-full bg-gray-300 flex items-center justify-center">
                                  <div className="w-0 h-0 border-y-[8px] border-y-transparent border-l-[14px] border-l-gray-400 ml-1" />
                                </div>
                              </div>
                            </div>
                        ...
                        >
                          ...
                          <div className="p-5 flex-1 hidden md:flex flex-col justify-between">
                            <div>
                              ...
                              <h4 className="text-xs font-black text-gray-900 uppercase tracking-tight line-clamp-1">
                                {video.title}
                              </h4>
                ...
                <div className="mb-6 px-2">
                  ...
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider mt-0.5">
                    Comprehensive step-by-step masterclasses
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {loading ? (
                        ...
                        >
                          <div>
                            ...
                            <div className="p-6">
                              ...
                              {/* Referral Bonus */}
                              <div className="h-7 w-36 bg-gray-200 rounded-lg mb-3" />
                    ...
                    courses.map((course) => {
                      ...
                      const courseAccess = accessRequests.find(
                        (req) =>
                          req.courseId === course._id ||
                          (req.videoType === "premium_training" &&
                            !req.courseId),
                      );
                      const courseStatus = courseAccess
                        ? courseAccess.status
                        : "none";
                      ...
                      return (
                        ...
                        >
                          <div>
                            <div
                              className={`aspect-[2/1] relative flex items-center justify-center bg-gradient-to-br ${isPremium ? "from-indigo-600 to-purple-600" : "from-emerald-500 to-teal-500"} p-6 text-white`}
                            >
                              <BookOpen
                                size={48}
                            ...
                            <div className="p-6">
                              ...
                              {course.referralBonus > 0 && (
                                <div className="inline-flex items-center gap-1 px-2.5 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-[10px] font-black uppercase tracking-wider mb-2 border border-emerald-100">
                                  ...
                                  />{" "}
                                  Refer & Earn: ৳{course.referralBonus}
                                </div>
                              )}
                              <p className="text-xs text-gray-500 font-medium leading-relaxed line-clamp-3 mb-4">
                                {course.description ||
                                  "No description provided."}
                              </p>
                            </div>
                          ...
                          <div className="px-6 pb-6 pt-2 border-t border-gray-100 flex items-center justify-between gap-4">
                            <div className="text-[11px] font-bold text-gray-400 uppercase tracking-wide">
                              {courseModules.length} Modules &bull;{" "}
                            ...
                            >
                              {isLocked ? (
                                ...
                                <>
                                  <Play size={12} fill="currentColor" /> Learn
                                </>
                              )}
                            </button>
                          </div>
                  ...
                  {!loading && courses.length === 0 && (
                    <div className="col-span-full py-24 text-center text-slate-400 font-bold uppercase tracking-widest">
                  ...
                  {isCourseLocked ? (
                    <div className="lg:col-span-12 max-w-2xl mx-auto w-full">
                      <div className="bg-white border border-gray-100 rounded-[2.5rem] shadow-sm overflow-hidden animate-in fade-in duration-300">
                        <div className="relative aspect-video bg-slate-900 flex flex-col items-center justify-center p-6 md:p-8 text-center">
                          ...
                          <p className="text-slate-400 font-medium mt-2 max-w-md text-xs">
                            Unlock this course and all premium training by
                        ...
                        <div className="p-5 md:p-8">
                          {premiumStatus === "pending" && (
                            <div className="flex flex-col items-center justify-center text-center py-6">
                              ...
                              <p className="text-gray-500 font-medium text-xs max-w-md mb-6">
                                Your payment of &#2547;{currentCoursePrice} is
                                currently being verified by our administrators.
                              </p>
                              <button
                                onClick={fetchData}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
                              <div className="bg-red-50 border border-red-200 rounded-[2rem] p-6 text-center">
                                ...
                                <p className="text-[11px] text-gray-600 font-medium mt-2">
                                  Previous payment could not be verified. Please
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              <div className="bg-gradient-to-br from-slate-900 to-slate-800 rounded-[2rem] p-6 text-white border border-slate-700 flex flex-col justify-between">
                                <div>
                                  ...
                                  <p className="text-xl font-black text-purple-400 mb-6">
                                    &#2547;{currentCoursePrice}{" "}
                    ...
                    <>
                        ...
                        {!activeVideo ? (
                          <div className="bg-white rounded-[2.5rem] p-8 md:p-12 text-center shadow-sm border border-gray-100 aspect-video flex flex-col items-center justify-center">
                            ...
                            <p className="text-gray-500 font-medium text-sm mt-2">
                              Choose a video from the curriculum on the right.
                            </p>
                          </div>
                        ) : (
                          <div className="bg-white border border-gray-100 rounded-[2.5rem] shadow-sm overflow-hidden animate-in fade-in duration-300">
                            ...
                            <div className="p-5 md:p-8">
                              <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-slate-100 text-slate-600 rounded-full text-[9px] font-black uppercase tracking-widest mb-3">
                                {activeVideo.videoType === "demo" && (
                                  <Youtube size={10} className="text-red-500" />
                                )}
                                {activeVideo.videoType === "free" && (
                              ...
                              <h1 className="text-xl lg:text-2xl font-black text-gray-900 uppercase tracking-tight mb-4">
                                {activeVideo.title}
                              </h1>
                              {activeVideo.description ? (
                                <p className="text-xs text-gray-600 font-medium leading-relaxed whitespace-pre-wrap break-words">
                                  {activeVideo.description}
                                </p>
                              ) : (
                      ...
                      <div className="lg:col-span-4 bg-white border border-gray-100 rounded-[2.5rem] p-5 shadow-sm h-fit max-h-[400px] md:max-h-[700px] overflow-y-auto">
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-tight mb-4 px-2">
                          Course Curriculum
                        </h3>
                        <div className="space-y-3">
                          {activeCourseModules.map((mod, modIdx) => {
                            const modVideos = videos.filter(
                              (v) =>
                                v.moduleId?._id === mod._id ||
                                v.moduleId === mod._id,
                            );
                              ...
                              >
                                ...
                                >
                                  <div className="flex items-center gap-2 min-w-0">
                                    ...
                                    <span className="font-black text-gray-800 uppercase tracking-tight text-xs truncate">
                                      {mod.title}
                                    </span>
                                  </div>
                                  <ChevronRight
                                ...
                                {isExpanded && (
                                  <div className="p-1 bg-white space-y-0.5">
                                    {modVideos.map((video) => {
                                      ...
                                      return (
                                        ...
                                        >
                                          <Play
                                            size={12}
                                            className={`shrink-0 ${isActive ? "text-emerald-500" : "text-gray-400"}`}
                                          />
                                          <span className="text-[11px] font-bold leading-tight flex-1 truncate">
                                            {video.title}
                                          </span>
                                          {video.videoType === "demo" && (
                                            <span className="text-[8px] font-black text-red-500 bg-red-50 px-1.5 py-0.5 rounded uppercase shrink-0">
                                              Demo
                                            </span>
                                          )}
                                          {video.videoType === "free" && (
                                            <span className="text-[8px] font-black text-emerald-600 bg-emerald-50 px-1.5 py-0.5 rounded uppercase shrink-0">
                                              Free
                                            </span>
                                          )}
                                        </button>
                                    ...
                                    {modVideos.length === 0 && (
                                      <div className="p-3 text-center text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                                        No videos
                                      </div>
                                    )}
                                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 animate-in fade-in duration-300">
            <div className="lg:col-span-5 bg-white border border-gray-100 rounded-[2.5rem] p-6 lg:p-8 shadow-sm h-fit">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-gray-900 uppercase tracking-tight">
                    কাস্টম অ্যাডস অর্ডার করুন
                  </h3>
                  <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">
                    ইউনিক ক্রিয়েটিভ দিয়ে আপনার সেলস বাড়ান
                  </p>
                </div>
              </div>
              <div className="bg-slate-50 border border-slate-100 rounded-3xl p-4 mb-6 text-xs text-slate-600 leading-relaxed font-medium">
                <span className="font-black text-slate-800 uppercase block mb-1">
                  প্রফেশনাল বিডি ড্রপশিপিং স্ট্যান্ডার্ড
                </span>
                আপনার টার্গেটেড অ্যাড ক্যাম্পেইনের জন্য আমাদের মিডিয়া
                বিশেষজ্ঞদের তৈরি হাই-কনভার্টিং প্রোডাক্ট ভিডিও পান।
              </div>
              <form onSubmit={handleSubmitCustomRequest} className="space-y-5">
                      ...
                      {showProductDropdown && (
                        <div className="absolute z-20 top-full left-0 right-0 mt-2 bg-white border border-gray-100 rounded-2xl shadow-xl max-h-60 overflow-y-auto">
                          {filteredProducts.length > 0 ? (
                            ...
                            <p className="text-xs font-bold text-center text-gray-400 p-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {Object.entries(customRequestTypeLabels).map(
                      ([val, label]) => (
                        <div
                          key={val}
                          onClick={() =>
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400 font-bold uppercase tracking-wider">
                      Track and download your delivered videos
                    </p>
                  </div>
                </div>
                <button
              ...
              {loadingRequests ? (
                ...
                <div className="flex-1 border border-dashed border-slate-100 rounded-[2rem] flex flex-col items-center justify-center p-8 text-center bg-slate-50/20">
                  ...
                  <p className="text-xs text-slate-400 font-medium max-w-xs mt-1.5">
                    Your requested custom video creatives will show up here.
                  </p>
                </div>
              ) : (
                <div className="space-y-4 max-h-[600px] overflow-y-auto pr-1">
                  {myRequests.map((req) => (
                    <div
                      key={req._id}
                      className={`p-5 rounded-3xl border transition-all ${req.status === "completed" ? "border-emerald-100 bg-emerald-50/10" : req.status === "rejected" ? "border-red-100 bg-red-50/10" : "border-slate-100"}`}
                    >
                      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-4">
                        <div className="flex items-start gap-4">
                          {req.productId?.images?.[0] ? (
                            ...
                            <div className="w-12 h-12 bg-slate-100 rounded-2xl flex items-center justify-center font-bold text-slate-400 text-xs">
                              P
                            </div>
                          )}
                          <div>
                            <h4 className="text-sm font-black text-gray-900 line-clamp-1">
                              {req.productId?.productName || "Deleted Product"}
                            </h4>
                        ...
                        <div
                          className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest flex items-center gap-1.5 self-start ${req.status === "completed" ? "bg-emerald-100 text-emerald-700" : req.status === "approved" ? "bg-blue-100 text-blue-700" : req.status === "rejected" ? "bg-red-100 text-red-700" : "bg-amber-100 text-amber-700"}`}
                        >
                          {req.status === "pending" ? (
                            <Clock size={12} />
                          ) : req.status === "approved" ? (
                      ...
                      {req.notes && (
                        <div className="bg-white border border-slate-100 rounded-2xl p-3 mb-3 text-xs text-gray-600 font-medium">
                          ...
                          <div className="break-words">{req.notes}</div>
                        </div>
                      )}
                      {req.adminNote && (
                        <div className="bg-amber-50/50 border border-amber-100 text-amber-800 rounded-2xl p-3 mb-3 text-xs font-medium flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <div className="break-words">{req.adminNote}</div>
                          </div>
                        </div>
                      )}
