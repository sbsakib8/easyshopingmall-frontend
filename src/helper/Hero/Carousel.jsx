  ...
  if (!slides || slides.length === 0) {
    return (
      <Section className="py-4 md:py-8 bg-gradient-to-b from-primary/5 from-20% to-100% to-primary/30">
        <Container className="relative h-[200px] sm:h-[400px] lg:h-[600px] w-full py-0!">
        ...
        >
          ...
          <div className="relative w-full h-full ">
            {slides?.map((slide, index) => (
              ...
              >
                <img
                  src={slide?.images?.[0] || slide?.image || "/img/product.jpg"}
        ...
        <div className="hidden lg:flex justify-center mt-4 space-x-2">
          {slides?.map((slide, index) => (
            ...
            >
              <img
                src={
                  (Array.isArray(slide?.images) ? slide.images[0] : slide?.images) ||
                  slide?.image ||
                  "/img/product.jpg"
                }
