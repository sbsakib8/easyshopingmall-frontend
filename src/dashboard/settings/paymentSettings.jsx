...
const PaymentSettings = () => {
 ...
 <div className="bg-gradient-to-br from-gray-800 via-gray-700 to-gray-800 rounded-xl shadow-2xl border border-gray-600 overflow-hidden hover:shadow-2xl hover:border-gray-500 transform">
 <div className="p-6">
