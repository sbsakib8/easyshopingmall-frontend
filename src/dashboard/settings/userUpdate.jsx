  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 p-4 md:p-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h1 className="text-3xl md:text-4xl font-bold text-slate-300">
                    User Management
                  </h1>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                      <span
                        className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${getStatusColor(user?.status)} text-slate-300`}
                      >
                        {user?.status}
                      </span>
                      {user?.verify_email && (
      ...
      {showModal && editingUser && (
        <Modal
          open={showModal && editingUser !== null}
          onClose={() => {
            setShowModal(false);
            setEditingUser(null);
          }}
        ...
        >
          <div className="relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl w-full max-w-2xl border border-gray-700 max-h-[90vh] overflow-y-auto">
            {/* Modal Header */}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setEditingUser({
                        ...editingUser,
                        last_login_date: e.target.value,
                      })
                    }
                    className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-xl text-slate-300 focus:outline-none focus:ring-2 focus:ring-purple-500"
                  />
