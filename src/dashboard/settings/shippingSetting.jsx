...
const ShippingSettings = () => {
 ...
 <button
 onClick={onClick}
 className={`flex items-center space-x-2 px-6 py-3 rounded-lg font-medium ${isActive
 ...
 <Card key={method.id} className="p-6 hover:shadow-3xl transform">
 ...
 {shippingZones.map(zone => (
 <Card key={zone.id} className="p-6 hover:shadow-3xl transform">
 <div className="flex justify-between items-start mb-4">
 <div className="flex items-center space-x-3">
 ...
 />
 <div className="w-11 h-6 bg-gray-600 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:rounded-full after:h-5 after:w-5 after: peer-checked:bg-gradient-to-r peer-checked:from-blue-500 peer-checked:to-purple-600"></div>
 </label>
 </div>
 ...
 className="w-full bg-gray-700 text-accent-content rounded-lg px-4 py-3 border border-gray-600 focus:border-blue-500 focus:outline-none"
 />
 </div>
 ...
 <button className="bg-gradient-to-r from-green-500 to-emerald-600 text-accent-content px-6 py-3 rounded-lg hover:from-green-600 hover:to-emerald-700 transform flex items-center space-x-2">
 <Save size={18} />
