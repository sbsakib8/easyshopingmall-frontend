...
const SecuritySettings = () => {
 ...
 <div className="flex items-center justify-between p-4 rounded-lg bg-gradient-to-r from-gray-800/50 to-gray-900/50 border border-gray-700/50 hover:border-purple-500/30">
 ...
 className={`relative inline-flex h-6 w-11 items-center rounded-full ${checked
 ?'bg-gradient-to-r from-purple-500 to-blue-500 shadow-lg shadow-purple-500/25'
 :'bg-gray-600'
}`}
 >
 <span
 className={`inline-block h-4 w-4 transform rounded-full bg-white ${checked ?'translate-x-6':'translate-x-1'
}`}
 />
 </button>
 </div>
 ...
 className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600 rounded-lg text-accent-content placeholder-gray-400 focus:ring-2 focus:ring-purple-500 focus:border-transparent"
 ...
 <button className="bg-gradient-to-r from-purple-500 to-blue-500 text-accent-content px-6 py-2 rounded-lg hover:from-purple-600 hover:to-blue-600 transform shadow-lg">
 Update Password
 </button>
 </div>
 </div>
 ...
 className="w-full px-4 py-2 bg-gray-700/50 border border-gray-600 rounded-lg text-accent-content focus:ring-2 focus:ring-purple-500 focus:border-transparent"
 >
 ...
 <button className="mt-4 bg-gradient-to-r from-green-500 to-emerald-500 text-accent-content px-4 py-2 rounded-lg hover:from-green-600 hover:to-emerald-600">
 Add IP Range
 </button>
 </div>
 </div>
 ...
 <div key={index} className="flex items-center justify-between p-3 bg-gray-700/30 rounded-lg hover:bg-gray-700/50">
 <div>
 ...
 className="p-2 text-gray-400 hover:text-accent-content"
 >
 {showApiKey ? <EyeOff className="h-4 w-4"/> : <Eye className="h-4 w-4"/>}
 </button>
 <button className="bg-gradient-to-r from-blue-500 to-purple-500 text-accent-content px-4 py-2 rounded-lg hover:from-blue-600 hover:to-purple-600">
 Regenerate
 </button>
 </div>
 </div>
 ...
 <button className="bg-gradient-to-r from-green-500 to-emerald-500 text-accent-content px-4 py-2 rounded-lg hover:from-green-600 hover:to-emerald-600">
 Regenerate
 </button>
 </div>
 </div>
 ...
 className={`py-4 px-2 border-b-2 font-medium text-sm flex items-center ${activeTab === tab.id
 ...
 <button className="bg-gradient-to-r from-purple-500 to-blue-500 text-accent-content px-8 py-3 rounded-xl hover:from-purple-600 hover:to-blue-600 transform shadow-xl shadow-purple-500/25 flex items-center">
