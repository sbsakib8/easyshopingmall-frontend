...
const ProductAnalytics = () => {
 ...
 <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl border border-gray-700 hover:border-purple-500 transform hover:shadow-2xl group">
 ...
 <div className="w-3 h-3 bg-purple-300 rounded-full"style={{animationDelay:'0.4s'}}></div>
 </div>
 </div>
 ...
 <div className="bg-gradient-to-r from-purple-500 to-pink-500 h-1 rounded-full"></div>
 </div>
 </div>
 </div>
