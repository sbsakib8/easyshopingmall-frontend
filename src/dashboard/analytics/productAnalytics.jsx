...
const ProductAnalytics = () => {
  ...
  const StatCard = ({ title, value, change, icon, isPositive }) => (
    <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl border border-gray-700 hover:border-purple-500 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl group">
      ...
      <div className="text-3xl font-bold text-accent-content mb-2 group-hover:text-purple-100 transition-colors duration-300">
        {isLoading ? (
  ...
  const ProductRow = ({ product, index }) => (
    <div className="flex items-center justify-between p-4 bg-gradient-to-r from-gray-800 to-gray-900 rounded-lg border border-gray-700 hover:border-purple-500 transition-all duration-300 transform hover:scale-102 hover:shadow-lg group animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
      <div className="flex items-center space-x-4">
        <div className="w-10 h-10 bg-gradient-to-br from-purple-500 to-purple-700 rounded-lg flex items-center justify-center text-accent-content font-bold group-hover:from-purple-400 group-hover:to-purple-600 transition-all duration-300">
          {index + 1}
        </div>
        <div>
          <div className="text-accent-content font-medium group-hover:text-purple-100 transition-colors duration-300">{product.name}</div>
      ...
      <div className="transition-all  duration-500 lg:ml-15 py-5 px-2 lg:px-9">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mt-4 md:mt-0">
            <select
              ...
              className="bg-gray-800 text-accent-content border border-gray-600 rounded-lg px-4 py-2 focus:border-purple-500 focus:outline-none transition-colors duration-300"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl border border-gray-700 hover:border-purple-500 transition-all duration-500 animate-fade-in">
            <div className="flex items-center justify-between mb-6">
              ...
              <button className="bg-gradient-to-r from-purple-500 to-purple-700 text-accent-content px-4 py-2 rounded-lg hover:from-purple-400 hover:to-purple-600 transition-all duration-300 transform hover:scale-105">
                View All
              </button>
            </div>
        ...
        <div className="bg-gradient-to-br from-gray-800 to-gray-900 p-6 rounded-xl border border-gray-700 hover:border-purple-500 transition-all duration-500 animate-fade-in">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            ...
            <div className="flex space-x-2">
              <button className="bg-purple-600 text-accent-content px-4 py-2 rounded-lg hover:bg-purple-500 transition-all duration-300 transform hover:scale-105">
                Export Data
              </button>
              <button className="bg-gray-700 text-accent-content px-4 py-2 rounded-lg hover:bg-gray-600 transition-all duration-300 transform hover:scale-105">
                Filter
              </button>
            </div>
          </div>
              ...
              <tbody>
                {topProducts.map((product, index) => (
                  <tr key={product.name} className="border-b border-gray-700 hover:bg-gray-800 transition-colors duration-300 animate-fade-in-up" style={{ animationDelay: `${index * 100}ms` }}>
                    ...
                    <td className="py-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-medium ${product.growth > 10 ? 'bg-green-800 text-green-200' :
