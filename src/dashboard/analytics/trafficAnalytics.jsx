...
const TrafficAnalyticsDashboard = () => {
 ...
 <div className="absolute bottom-1/4 left-1/3 w-64 h-64 bg-pink-500/10 rounded-full blur-2xl"></div>
 </div>
 ...
 <div className="lg:ml-15 py-5 px-2 lg:px-9 space-y-6">
 {/* Header */}
 <div className="-in-up">
 ...
 {/* Metric Cards */}
 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 -up-stagger">
 {isLoading ? (
 Array(6)
 .fill(0)
 .map((_, i) => (
...
"rgba(16, 185, 129, 0.7)",
 ...
 <div className="text-center p-4 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10">
...
function EnhancedMetricCard({title, value, change, positive, icon, gradient}) {
 ...
 <div
 className={`absolute inset-0 bg-gradient-to-r ${gradient} rounded-xl blur opacity-20 group-hover:opacity-40 `}
 ></div>
 <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 cursor-pointer shadow-2xl">
