...
const DashboardHome = () => {
 ...
 <div
 key={card.title}
 className={`group relative bg-white/10 backdrop-blur-xl p-6 rounded-3xl border border-gray-800/50 shadow-lg ${card.shadowColor} overflow-hidden`}
 >
 <div
 ...
 className="group relative bg-white/5 backdrop-blur-xl p-4 sm:p-6 rounded-2xl border border-gray-800/30 shadow-lg overflow-hidden cursor-pointer"
 >
 <div
 ...
 <div className="relative z-10">
 <div
 className={`w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-r ${action.gradient} flex items-center justify-center mb-3 shadow-lg shadow-black/50`}
 >
