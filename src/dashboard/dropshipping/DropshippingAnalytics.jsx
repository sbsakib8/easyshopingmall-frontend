      ...
      <Container className="space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-5">
          {kpiCards.map((card, idx) => (
            <div
              key={idx}
              className="relative group overflow-hidden bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-[2rem] p-6 transition-all hover:bg-gray-900/80 hover:scale-[1.02] hover:border-indigo-500/30"
            >
              <div
          ...
          <div className="bg-gray-900/40 border border-gray-800 rounded-[3rem] p-8 relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-3 mt-6">
              {pipelineData.map((item, idx) => (
                <div
                  key={idx}
                  className="flex items-center justify-between p-2 rounded-xl bg-gray-950/30 border border-gray-800/50"
                >
            ...
            <table className="w-full text-left">
              <thead className="sticky top-0 bg-slate-900/95 backdrop-blur-md z-20">
                <tr className="border-b border-gray-800">
                  ...
                  <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] text-center">
                    Orders
                  </th>
                  <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] text-right">
                    Revenue
                  </th>
                  <th className="px-4 py-5 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] text-right">
                    Total Profit
