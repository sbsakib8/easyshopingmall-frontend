...
const HomeSliderPage = () => {
 ...
 <button
 key={index}
 className={`w-3 h-3 rounded-full ${index === currentSlide ?"bg-white scale-125":"bg-white/50 hover:bg-white/75"
}`}
 ...
 className={`px-4 py-2 rounded-lg text-sm font-medium ${slider?.active
