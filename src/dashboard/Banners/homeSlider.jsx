      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-12 text-center">
          ...
          <p className="text-gray-400 text-xl max-w-2xl mx-auto text-pretty">
            Create and manage beautiful sliders for your homepage with stunning
            animations
          </p>
        </div>
                  ...
                  <div>
                   ...
                   <div>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, sliderFor: e.target.value })
                      }
                ...
                {sliders
                  ...
                  ?.map((slider, index) => (
                    ...
                    >
                      <img
                        src={
                          (Array.isArray(slider?.images)
                            ? slider.images[0]
                            : slider?.images) || "/img/product.jpg"
                        }
                        alt={slider?.title}
                        className="w-full md:w-24 h-20 object-cover rounded-lg shadow-lg"
                      />
                      <div className="flex-1">
                        <h4 className="font-bold text-slate-300 text-lg mb-2">
                          {slider?.title}
                        </h4>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <button
                          ...
                          className="px-4 py-2 bg-blue-600/20 text-blue-400 border border-blue-600/30 hover:bg-blue-600/30 rounded-lg text-sm font-medium"
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
        ...
        >
          <div className="relative bg-gradient-to-br from-gray-900 to-black border border-gray-700 rounded-2xl p-8 max-w-md w-full max-h-[90vh] overflow-y-auto shadow-2xl">
            <h3 className="text-2xl font-bold text-slate-300 mb-6">
              Edit Slider
            </h3>
            <div className="space-y-4">
