...
import {RightBannerCreate, RightBannerDelete, RightBannerUploade} from"@/src/hook/userRightBanner"
...
const RightBanner = () => {
 ...
 <div
 className="absolute top-1/2 left-1/4 w-64 h-64 bg-gradient-to-r from-emerald-500/15 to-teal-500/15 rounded-full blur-3xl"
 style={{animationDelay:"2s"}}
 ></div>
 <div
 className="absolute bottom-1/3 left-1/2 w-72 h-72 bg-gradient-to-r from-orange-500/15 to-red-500/15 rounded-full blur-3xl"
 ...
 className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-accent-content px-6 py-3 rounded-xl font-semibold transform hover:shadow-2xl hover:shadow-emerald-500/25"
 >
 Toggle All Status
 </button>
 <button
 onClick={() => openModal()}
 className="bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 hover:from-purple-600 hover:via-pink-600 hover:to-blue-600 text-accent-content px-8 py-3 rounded-xl font-semibold transform hover:shadow-2xl hover:shadow-purple-500/25"
 >
 ✨ Create New Banner
 </button>
 </div>
 ...
 className="w-full px-6 py-4 bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl text-accent-content placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
 />
 ...
 className="px-6 py-4 bg-gray-800/50 backdrop-blur-sm border border-gray-700/50 rounded-xl text-accent-content focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
 >
 ...
 <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 hover:from-purple-500/30 hover:to-pink-500/30 transform hover:shadow-2xl hover:shadow-purple-500/25">
 ...
 <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 backdrop-blur-sm border border-emerald-500/30 rounded-2xl p-6 hover:from-emerald-500/30 hover:to-teal-500/30 transform hover:shadow-2xl hover:shadow-emerald-500/25">
 <div className="flex items-center justify-between">
 <div>
 ...
 <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 backdrop-blur-sm border border-orange-500/30 rounded-2xl p-6 hover:from-orange-500/30 hover:to-red-500/30 transform hover:shadow-2xl hover:shadow-orange-500/25">
 <div className="flex items-center justify-between">
 <div>
 ...
 <div
 key={banner.id}
 className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden hover:from-gray-700/60 hover:to-gray-800/60 transform hover:shadow-2xl hover:shadow-purple-500/20 group"
 ...
 />
 <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100"></div>
 <div
 ...
 <div className="p-6">
 <h3 className="text-xl font-bold text-accent-content mb-3 group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 group-hover:bg-clip-text group-hover:text-transparent">
 {banner.title}
 </h3>
 ...
 className="px-6 py-3 bg-gradient-to-r from-gray-700/50 to-gray-800/50 border border-gray-600/50 rounded-xl text-accent-content hover:from-gray-600/60 hover:to-gray-700/60 disabled:opacity-50 disabled:cursor-not-allowed transform"
 >
 ← Previous
 </button>
 ...
 className={`px-5 py-3 rounded-xl font-semibold transform ${currentPage === page
 ...
 className="w-full px-6 py-4 bg-gray-800/50 border border-gray-700/50 rounded-xl text-accent-content placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
 ...
 rows={4}
 className="w-full px-6 py-4 bg-gray-800/50 border border-gray-700/50 rounded-xl text-accent-content placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50 resize-none"
 ...
 className="w-full px-6 py-4 bg-gray-800/50 border border-gray-700/50 rounded-xl text-accent-content focus:outline-none focus:ring-2 focus:ring-purple-500/50 focus:border-purple-500/50"
 >
 ...
 <button
 type="submit"
 className="flex-1 px-8 py-4 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 text-accent-content rounded-xl font-semibold hover:from-purple-600 hover:via-pink-600 hover:to-blue-600 transform hover:shadow-2xl hover:shadow-purple-500/25"
 >
