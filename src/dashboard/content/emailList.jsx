    ...
    <div className="flex items-start justify-between gap-3">
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          ...
          <div className="h-5 bg-purple-500/20 rounded w-32"></div>
        </div>
        <div className="h-4 bg-purple-500/20 rounded w-48 mb-1"></div>
        <div className="h-3 bg-purple-500/20 rounded w-64"></div>
      </div>
      <div className="flex flex-col items-end gap-2 flex-shrink-0">
        <div className="h-3 bg-purple-500/20 rounded w-16"></div>
...
const ContactInboxDashboard = () => {
  ...
  if (error) {
    return (
      <Section className="min-h-dvh bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center bg-red-500/20 backdrop-blur-lg rounded-2xl border border-red-500/50 p-8 max-w-md">
          <div className="text-red-400 text-6xl mb-4">⚠️</div>
          <h2 className="text-slate-300 text-2xl font-bold mb-2">
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <h3 className="text-slate-300 font-medium truncate">
                            {contact.name}
                          </h3>
                        </div>
                        <p className="text-purple-200 text-sm truncate mb-1">
                          {contact.subject}
                        </p>
