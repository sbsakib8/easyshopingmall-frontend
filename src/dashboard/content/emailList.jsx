...
const ContactInboxDashboard = () => {
 ...
 <div className="text-slate-300 text-xl">Loading messages...</div>
 </div>
 </div>
 );
}
 ...
 <h2 className="text-slate-300 text-2xl font-bold mb-2">Error Loading Messages</h2>
 <p className="text-red-200 mb-4">Failed to fetch contact messages</p>
 <button
 onClick={handleRefresh}
 className="bg-red-500 hover:bg-red-600 text-slate-300 px-6 py-2 rounded-lg"
 >
 Try Again
 </button>
 </div>
 ...
 <div>
 <h1 className="text-3xl md:text-4xl font-bold text-slate-300 mb-2">Contact Inbox</h1>
 <p className="text-purple-200">Manage your customer messages</p>
 </div>
 <button
 onClick={handleRefresh}
 disabled={refreshing}
 className="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-slate-300 px-4 py-2 rounded-lg disabled:opacity-50"
 >
 ...
 className={`p-4 cursor-pointer hover:bg-white/20 ${selectedContact?._id === contact._id ?'bg-white/20 border-l-4 border-purple-400':''
}`}
 style={{
 ...
 <h3 className="text-slate-300 font-medium truncate">{contact.name}</h3>
 </div>
 ...
 <h2 className="text-2xl font-bold text-slate-300">{selectedContact.subject}</h2>
 <button
 ...
 <p className="text-slate-300 font-medium">{selectedContact.name}</p>
 </div>
 ...
 <p className="text-slate-300 font-medium break-all">{selectedContact.email}</p>
 </div>
 ...
 <p className="text-slate-300 font-medium">{selectedContact.phone ||'Not provided'}</p>
 </div>
 ...
 <p className="text-slate-300 font-medium">{getTimeAgo(selectedContact.createdAt)}</p>
 </div>
 </div>
