...
const ContactInboxDashboard = () => {
 ...
 className="bg-red-500 hover:bg-red-600 text-accent-content px-6 py-2 rounded-lg"
 >
 Try Again
 </button>
 </div>
 ...
 onClick={handleRefresh}
 disabled={refreshing}
 className="flex items-center gap-2 bg-white/10 hover:bg-white/20 text-accent-content px-4 py-2 rounded-lg disabled:opacity-50"
 >
