...
const BlogsAdminDashboard = () => {
 ...
 <div className="bg-gradient-to-r from-blue-500/20 to-blue-600/20 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-6 hover:transform">
 ...
 <div className="bg-gradient-to-r from-green-500/20 to-green-600/20 backdrop-blur-sm border border-green-500/30 rounded-2xl p-6 hover:transform">
 <div className="flex items-center justify-between">
 <div>
 ...
 <div className="bg-gradient-to-r from-yellow-500/20 to-yellow-600/20 backdrop-blur-sm border border-yellow-500/30 rounded-2xl p-6 hover:transform">
 <div className="flex items-center justify-between">
 <div>
 ...
 <div className="bg-gradient-to-r from-purple-500/20 to-purple-600/20 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 hover:transform">
 <div className="flex items-center justify-between">
 <div>
 ...
 <div key={blog._id || blog.id} className="group bg-gray-800/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden hover:border-blue-500/50 transform hover:shadow-2xl hover:shadow-blue-500/20">
