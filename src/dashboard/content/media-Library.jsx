...
export default function WebsiteInfoAdmin() {
 ...
 return (
 <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black p-4 md:p-6 text-slate-300 overflow-hidden">
 ...
 <div>
 <h1 className="text-2xl md:text-3xl font-bold text-slate-300">Website Info Management</h1>
 <p className="text-slate-300 mt-1">Admin Dashboard</p>
 </div>
 <div className="flex gap-3 w-full md:w-auto">
 <button
 onClick={refetch}
 disabled={dataLoading || loading}
 className="flex items-center justify-center gap-2 bg-gray-600 text-slate-300 px-4 py-2 rounded-lg hover:bg-gray-700 disabled:opacity-50 flex-1 md:flex-initial"
 >
 ...
 className="flex items-center justify-center gap-2 bg-indigo-600 text-slate-300 px-4 py-2 rounded-lg hover:bg-indigo-700 flex-1 md:flex-initial"
 >
 ...
 className="flex items-center gap-2 bg-green-600 text-slate-300 px-3 py-1 rounded-lg hover:bg-green-700 text-sm"
 >
 ...
 className="ml-auto bg-red-500 p-2 rounded-lg hover:bg-red-600"
 >
 ...
 type="submit"
 disabled={loading}
 className="flex items-center justify-center gap-2 bg-indigo-600 text-slate-300 px-6 py-3 rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 <div key={info._id} className="border border-gray-200 rounded-lg p-4 md:p-6 hover:shadow-md">
 ...
 disabled={loading}
 className="flex items-center justify-center gap-2 bg-red-600 text-slate-300 px-4 py-2 rounded-lg hover:bg-red-700 disabled:opacity-50"
 >
 <Trash2 className="w-4 h-4"/>
 </button>
 </div>
 ...
 className="bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full text-xs hover:bg-indigo-200"
 >
 {social.platform}
 </a>
 ))}
