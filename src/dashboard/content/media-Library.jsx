...
export default function WebsiteInfoAdmin() {
...
} text-accent-content px-6 py-3 rounded-lg shadow-lg flex items-center gap-2 -in`}>
 ...
 className="flex items-center justify-center gap-2 bg-gray-600 text-accent-content px-4 py-2 rounded-lg hover:bg-gray-700 disabled:opacity-50 flex-1 md:flex-initial"
 >
 ...
 className="flex items-center justify-center gap-2 bg-indigo-600 text-accent-content px-4 py-2 rounded-lg hover:bg-indigo-700 flex-1 md:flex-initial"
 >
 ...
 className="flex items-center gap-2 bg-green-600 text-accent-content px-3 py-1 rounded-lg hover:bg-green-700 text-sm"
 >
 ...
 type="submit"
 disabled={loading}
 className="flex items-center justify-center gap-2 bg-indigo-600 text-accent-content px-6 py-3 rounded-lg hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 disabled={loading}
 className="flex items-center justify-center gap-2 bg-red-600 text-accent-content px-4 py-2 rounded-lg hover:bg-red-700 disabled:opacity-50"
 >
 <Trash2 className="w-4 h-4"/>
 </button>
 </div>
