...
const ManageCoupons = () => {
 ...
 className="mt-4 md:mt-0 px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-2xl font-bold shadow-lg transform flex items-center space-x-2 border border-white/10"
 >
 ...
 <div 
 key={coupon._id}
 className={`group relative bg-black/40 border ${coupon.isActive ?'border-white/10':'border-red-900/50'} rounded-3xl p-6 hover:bg-white/10 hover:shadow-2xl overflow-hidden`}
 >
 {/* Status Badge */}
