...
const ShippedOrdersPage = () => {
 ...
 {/* over view section */}
 <div
 className={`grid grid-cols-1 md:grid-cols-4 gap-6 transform ${animateCards ?"translate-y-0 opacity-100":"translate-y-10 opacity-0"} mb-8`}
 >
 ...
 <button onClick={() => setShowModal(false)} className="text-gray-400 hover:text-red-400 cursor-pointer bg-red-500/40 rounded-2xl p-1">
