...
import {AlertTriangle, BarChart3, DollarSign, Download, Edit, Eye, MoreHorizontal, Package, Plus, Search, Star, Tag, Trash2, TrendingDown, TrendingUp, Upload, X} from'lucide-react';
...
const InventoryDashboard = () => {
 ...
 <div className="absolute -top-1/2 -left-1/2 w-full h-full bg-gradient-to-br from-blue-500/10 to-transparent rounded-full"></div>
 <div className="absolute -bottom-1/2 -right-1/2 w-full h-full bg-gradient-to-tl from-purple-500/10 to-transparent rounded-full"></div>
 ...
 <div className="group relative overflow-hidden bg-gradient-to-br from-emerald-500 via-green-500 to-teal-500 p-6 rounded-3xl shadow-2xl hover:shadow-emerald-500/25 hover:rotate-1">
 ...
 <div className="group relative overflow-hidden bg-gradient-to-br from-amber-500 via-orange-500 to-red-500 p-6 rounded-3xl shadow-2xl hover:shadow-amber-500/25 hover:-rotate-1">
 <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
 <div className="relative z-10">
 <div className="flex items-center justify-between mb-4">
 ...
 <div className="group relative overflow-hidden bg-gradient-to-br from-red-500 via-red-400 to-red-600 p-6 rounded-3xl shadow-2xl hover:shadow-cyan-500/25 hover:-rotate-1">
 <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
 <div className="relative z-10">
 <div className="flex items-center justify-between mb-4">
 ...
 {/* <div className="group relative overflow-hidden bg-gradient-to-br from-rose-500 via-pink-500 to-purple-500 p-6 rounded-3xl shadow-2xl hover:shadow-rose-500/25 hover:rotate-1">
 <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
 <div className="relative z-10">
 <div className="flex items-center justify-between mb-4">
...
'bg-red-500/20 text-red-300'
 ...
 <div
 className={`h-full ${stockPercentage > 50 ?'bg-gradient-to-r from-green-400 to-emerald-500':
