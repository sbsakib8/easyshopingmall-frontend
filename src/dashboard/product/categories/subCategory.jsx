...
const AddSubcategoriesComponent = () => {
 ...
 <div
 key={subcategory._id}
 className="bg-white/5 border border-white/20 min-h-[350px] rounded-2xl p-3 hover:bg-white/10 transform hover:shadow-2xl relative"
 >
 ...
 className={`p-2 rounded-lg ${subcategory.isActive
 ...
 className="px-4 py-2 bg-red-500/20 text-red-400 rounded-lg hover:bg-red-500/30 flex items-center justify-center transform"
 >
 <Trash2 size={16} />
 ...
 <div>
 <div className="font-semibold text-accent-content text-lg group-hover:text-indigo-300">
 {subcategory.name}
 </div>
 ...
 <div key={subcat._id} className="flex items-center justify-between p-3 bg-white/3 rounded-lg hover:bg-white/5">
 <div className="flex items-center space-x-3">
 ...
 className="w-full px-4 py-2 bg-green-500/20 text-green-400 rounded-lg hover:bg-green-500/30"
 >
 View Analytics
 </button>
 </div>
