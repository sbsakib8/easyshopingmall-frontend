...
const ProductDashboard = () => {
 ...
 {/* Filters and Actions */}
 <div
 className="bg-gradient-to-r from-gray-900/90 via-gray-800/90 to-gray-900/90 backdrop-blur-xl rounded-3xl border border-gray-700/30 shadow-2xl p-6 sm:p-8 mb-8"
 >
 ...
 {/* Products Table */}
 <div
 className="bg-gradient-to-br from-gray-900/90 via-gray-800/90 to-black/90 backdrop-blur-xl rounded-3xl border border-gray-700/30 shadow-2xl overflow-hidden"
 >
 ...
 <div
 key={index}
 className="group px-4 sm:px-6 py-4 hover:bg-gradient-to-r hover:from-gray-800/50 hover:to-gray-700/50"
 >
 {/* Desktop Layout */}
 ...
 className="w-16 h-16 rounded-2xl object-cover shadow-lg border-2 border-gray-600/50"
 />
 </div>
 <div>
 <h3 className="font-bold text-accent-content text-sm mb-1">
 {product?.productName}
 </h3>
 ...
 <span className="inline-flex items-center px-3 py-2 rounded-xl text-xs font-bold bg-gradient-to-r from-gray-700 to-gray-600 text-gray-200 border border-gray-600/50">
 {product?.brand}
 </span>
 </div>
 ...
 className="p-2 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-accent-content rounded-lg shadow-lg hover:shadow-cyan-500/25"
 >
 <Eye size={16} />
 </button>
 <button
 onClick={() => handleEdit(product)}
 className="p-2 bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-400 hover:to-green-400 text-accent-content rounded-lg shadow-lg hover:shadow-emerald-500/25"
 >
 <Edit size={16} />
 </button>
 <button
 onClick={() => handleDelete(product?._id)}
 className="p-2 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-400 hover:to-pink-400 text-accent-content rounded-lg shadow-lg hover:shadow-red-500/25"
 >
 <Trash2 size={16} />
 </button>
 <button className="p-2 bg-gray-700/50 hover:bg-gray-600/50 text-gray-300 hover:text-accent-content rounded-lg">
 ...
 src={product?.images[0]}
 alt={product?.productName}
 className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl object-cover shadow-lg border-2 border-gray-600/50"
 />
 </div>
 ...
 <h3 className="font-bold text-accent-content text-sm sm:text-base mb-1">
 {product?.productName}
 </h3>
 ...
 <button
 onClick={() => handleView(product)}
 className="p-2 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-accent-content rounded-lg shadow-lg"
 >
 <Eye size={14} />
 </button>
 <button
 ...
 <button
 onClick={() => handleDelete(product?._id)}
 className="p-2 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-400 hover:to-pink-400 text-accent-content rounded-lg shadow-lg"
 >
 <Trash2 size={14} />
 </button>
 </div>
 ...
 <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-accent-content rounded-xl shadow-lg font-medium">
 Clear Filters
 </button>
 </div>
 )}
 ...
 <div
 key={metric.title}
 className={`bg-gradient-to-br ${metric.color} rounded-2xl p-6 text-accent-content shadow-xl transform relative overflow-hidden animate-slideUp`}
