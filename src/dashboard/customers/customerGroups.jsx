...
const CustomerGroups = () => {
 ...
 className="w-full bg-gradient-to-r from-gray-800/80 to-gray-700/80 border border-gray-600/50 rounded-xl px-4 py-3 text-slate-300 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent"
 />
 ...
 className="bg-gradient-to-r from-gray-800/80 to-gray-700/80 border border-gray-600/50 rounded-xl px-4 py-3 text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
 >
 ...
 <p className="text-3xl font-bold text-slate-300">{groups.length}</p>
 </div>
 ...
 <div
 key={group.id}
 className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-gray-600/50 transform hover:shadow-xl hover:shadow-gray-900/50 group"
 >
 {/* Group Header */}
 <div className="flex items-center justify-between mb-4">
 <div className="flex items-center space-x-3">
 <div className="w-4 h-4 rounded-full"style={{backgroundColor: group.color}}></div>
 <h3 className="text-xl font-bold text-slate-300 group-hover:text-gray-200">
 {group.name}
 </h3>
 </div>
 ...
 <p className="text-slate-300 font-bold text-lg">{group.totalCustomers}</p>
 </div>
 <div className="bg-gradient-to-r from-gray-700/30 to-gray-600/30 rounded-lg p-3">
 <p className="text-gray-400 text-xs">Revenue</p>
 <p className="text-slate-300 font-bold text-lg">${group.totalRevenue.toLocaleString()}</p>
 </div>
 </div>
 ...
 <h2 className="text-2xl font-bold text-slate-300 mb-6">Create New Group</h2>
 ...
 className="w-full bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
 ...
 className="w-full bg-gray-700/50 border border-gray-600 rounded-lg px-4 py-3 text-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 h-24 resize-none"
 ...
 className="flex-1 bg-gray-600 hover:bg-gray-700 text-slate-300 py-3 rounded-lg font-medium"
 >
 Cancel
 </button>
 <button
 onClick={handleCreateGroup}
 className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-slate-300 py-3 rounded-lg font-medium"
 >
 Create Group
 </button>
 </div>
 ...
 <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
 <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl p-8 w-full max-w-md border border-gray-700">
 <h2 className="text-2xl font-bold text-slate-300 mb-6">Edit Group</h2>
 ...
 <h2 className="text-3xl font-bold text-slate-300">{selectedGroup.name}</h2>
 </div>
 <button
 ...
 <p className="text-2xl font-bold text-slate-300">{selectedGroup.totalCustomers}</p>
 </div>
 ...
 <p className="text-2xl font-bold text-slate-300">${selectedGroup.totalRevenue.toLocaleString()}</p>
 </div>
 ...
 <p className="text-2xl font-bold text-slate-300">{selectedGroup.createdAt}</p>
 </div>
 </div>

 <h3 className="text-xl font-bold text-slate-300 mb-4">Customers in this group</h3>
 ...
 <div>
 <h4 className="text-slate-300 font-medium">{customer.name}</h4>
 <p className="text-gray-400 text-sm">{customer.email}</p>
 </div>
 <div className="text-right">
 <p className="text-slate-300 font-medium">{customer.totalOrders} orders</p>
