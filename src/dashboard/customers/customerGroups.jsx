...
const CustomerGroups = () => {
 ...
 className="w-full bg-gradient-to-r from-gray-800/80 to-gray-700/80 border border-gray-600/50 rounded-xl px-4 py-3 text-accent-content placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent"
 />
 ...
 className="bg-gradient-to-r from-gray-800/80 to-gray-700/80 border border-gray-600/50 rounded-xl px-4 py-3 text-accent-content focus:outline-none focus:ring-2 focus:ring-blue-500/50"
 >
 ...
 className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-accent-content px-6 py-3 rounded-xl font-semibold transform hover:shadow-lg hover:shadow-blue-500/25"
 >
 + Create Group
 </button>
 </div>
 ...
 <h3 className="text-xl font-bold text-accent-content group-hover:text-gray-200">
 {group.name}
 </h3>
 </div>
 ...
 className="flex-1 bg-gray-600 hover:bg-gray-700 text-accent-content py-3 rounded-lg font-medium"
 >
 Cancel
 </button>
 <button
 onClick={handleCreateGroup}
 className="flex-1 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-accent-content py-3 rounded-lg font-medium"
 >
 Create Group
 </button>
 </div>
