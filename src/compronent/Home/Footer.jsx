...
function Footer({ initialData }) {
    ...
    return (
      <footer className="px-20 mx-auto bg-secondary pb-20 md:pb-0">
        {/* main div */}
        <div className="w-[98%] lg:w-[95%] flex flex-wrap justify-between items-center gap-4 lg:gap-0 py-4 px-2 lg:px-0">
          <div className="w-[400px] h-auto">
            ...
            <p className=" text-[17px] mt-2 text-accent">
          ...
          <div className="w-[200px] h-auto mt-3 ">
            ...
            <div>
              <p className=" text-[16px] my-3 text-accent hover:text-primary-color cursor-pointer hover:transition-al hover:ml-4 hover:duration-200">
        ...
        <div className=" flex flex-col md:flex-row justify-between items-center mt-3">
          <div>
            <p className=" text-center text-wrap text-accent text-[16px] my-4">
              © 2026 EasyShoppingMall. All rights reserved.
            </p>
          </div>
