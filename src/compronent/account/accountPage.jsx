...
const AccountPage = () => {
  ...
  const addresses = (data && (data.addresses || (data.address_details ? [
    {
      id: 1,
      type: 'Home',
      address: data.address_details,
  ...
  const TabButton = ({ id, icon: Icon, label, count }) => (
    ...
    >
      ...
      {count && (
        <span className={`ml-auto px-2 py-1 text-xs rounded-full ${activeTab === id ? 'bg-white/20' : 'bg-blue-100 text-blue-600'
          }`}>
          {count}
        </span>
      )}
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-lg p-6 sticky top-6">
                ...
                <nav className="space-y-2 ">
                  ...
                  <TabButton id="orders" icon={Package} label="Orders" count={orders?.length || 0} />
                  <TabButton id="wishlist" icon={Heart} label="Wishlist" count={wishlist?.length || 0} />
                      ...
                      <div className="md:col-span-2 space-y-2">
                        ...
                        <div className="relative">
                          ...
                          <textarea
                            ...
                            disabled={!isEditing}
                            rows="3"
                            className={`w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-green-500 transition-all duration-300 resize-none ${!isEditing ? 'bg-gray-50' : 'bg-white hover:border-gray-300'
                              }`}
                          />
                        </div>
                      </div>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center space-x-4">
                                <img src={image} alt="Order" className="w-12 h-12 rounded-lg object-cover" />
                                <div>
                                  <h3 className="font-semibold text-gray-900 group-hover:text-green-600 transition-colors">
                                    Order {id}
                                  </h3>
                                  <p className="text-sm text-gray-500">{date} • {itemsCount} items</p>
                                </div>
                              </div>
                              <div className="flex items-center space-x-4">
                  ...
                  <div className="p-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {(wishlist || []).map((item, index) => {
                        ...
                        const image = prod.image || prod.images?.[0] || (Array.isArray(prod.image) ? prod.image[0] : null) || '/banner/img/placeholder.png';
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex space-x-2">
                              <button className="flex-1 cursor-pointer bg-teal-500 hover:bg-green-600 text-white py-2 rounded-lg font-medium transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">Add to Cart</button>
                              <button className="p-2 border cursor-pointer border-gray-200 rounded-lg hover:border-red-300 hover:text-red-500 transition-all duration-300"><Trash2 className="w-5 h-5" /></button>
                            </div>
                          </Link>
                        );
                      })}
                        ...
                        <div className="space-y-4">
                          {[
                            ...
                            <div key={setting.id} className="flex items-center justify-between">
                              ...
                              >
                                <div className={`w-5 h-5 rounded-full bg-white shadow-md transform transition-transform duration-300 ${setting.enabled ? 'translate-x-6' : 'translate-x-1'
                                  }`} />
                              </button>
                            </div>
                          ))}
