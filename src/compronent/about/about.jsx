...
const AboutPage = () => {
  ...
  return (
    <section className="min-h-dvh lg:mt-12 py-5 bg-bg">
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className={`text-center group cursor-pointer transform transition-all duration-500 hover:scale-105 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                ...
                <div className="mb-4 flex justify-center">
                  <div className="p-4 bg-gradient-to-r from-btn-color/80 via-btn-color/95 to-btn-color rounded-full group-hover:shadow-lg group-hover:shadow-blue-500/25 transition-all duration-300">
                    <stat.icon className="w-8 h-8 text-accent-content" />
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div key={index} className={`bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                }`} style={{ transitionDelay: `${index * 300}ms` }}>
                <div className="flex justify-center mb-6">
                  <div className="p-4 bg-gradient-to-r from-btn-color/80 via-btn-color/95 to-btn-color rounded-full">
                    <value.icon className="w-8 h-8 text-accent-content" />
                  </div>
                </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {features.map((feature, index) => (
                <div key={index} className={`flex items-center space-x-4 p-4 bg-white rounded-lg shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-300 ${isVisible ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
                  }`} style={{ transitionDelay: `${index * 200}ms` }}>
      ...
      <div className="py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link href='/shop' className="bg-gradient-to-r from-btn-color/80 via-btn-color/95 to-btn-color text-accent-content px-8 py-4 rounded-full text-lg font-semibold hover:shadow-lg hover:shadow-blue-500/25 transform hover:scale-105 transition-all duration-300">
            এখনই শপিং শুরু করুন
          </Link>
        </div>
      </div>
